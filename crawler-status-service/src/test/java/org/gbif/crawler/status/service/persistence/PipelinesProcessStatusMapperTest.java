...
public class PipelinesProcessStatusMapperTest extends BaseMapperTest {
  ...
  public void duplicatePipelinesProcessTest() {
    ...
    // insert one process
    PipelinesProcessStatus process =
        new PipelinesProcessStatus().setDatasetKey(UUID.randomUUID()).setAttempt(1);
    pipelinesProcessMapper.create(process);
  ...
  public void listAndCountTest() {
    ...
    pipelinesProcessMapper.create(new PipelinesProcessStatus().setDatasetKey(uuid1).setAttempt(1));
    pipelinesProcessMapper.create(new PipelinesProcessStatus().setDatasetKey(uuid1).setAttempt(2));
