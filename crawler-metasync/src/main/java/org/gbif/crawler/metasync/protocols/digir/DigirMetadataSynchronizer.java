...
/**
 * DiGIR synchronization happens by issuing a metadata request to the single endpoint that the
 ...
 */
public class DigirMetadataSynchronizer extends BaseProtocolHandler {
  private static final Logger LOG = LoggerFactory.getLogger(DigirMetadataSynchronizer.class);
  ...
  public DigirMetadataSynchronizer(HttpClient httpClient) {
    super(httpClient);
  }
