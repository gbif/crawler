...
/**
 * Synchronizes metadata from a BioCASe Installation.
 *
 ...
 * Archive, DwC-A).
 *
 * <p>BioCASe synchronization happens in the following steps:
 *
 * <ul>
...
public class BiocaseMetadataSynchronizer extends BaseProtocolHandler {
  private static final Logger LOG = LoggerFactory.getLogger(BiocaseMetadataSynchronizer.class);

  public BiocaseMetadataSynchronizer(HttpClient httpClient) {
    super(httpClient);
  }
