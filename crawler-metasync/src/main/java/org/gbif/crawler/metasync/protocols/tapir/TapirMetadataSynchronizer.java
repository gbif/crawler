 ...
 */
package org.gbif.crawler.metasync.protocols.tapir;
...
import org.gbif.crawler.metasync.protocols.tapir.model.capabilities.Capabilities;
import org.gbif.crawler.metasync.protocols.tapir.model.capabilities.Schema;
import org.gbif.crawler.metasync.protocols.tapir.model.metadata.TapirContact;
import org.gbif.crawler.metasync.protocols.tapir.model.metadata.TapirMetadata;
import org.gbif.crawler.metasync.protocols.tapir.model.metadata.TapirRelatedEntity;
import org.gbif.crawler.metasync.protocols.tapir.model.search.TapirSearch;
...
/**
 * Synchronizes metadata from a TAPIR Installation.
 *
 ...
 * </ol>
 *
 * Note: If there is an exception during processing one of the Endpoints the whole synchronization
 * process will be aborted. I'm doing this to prevent inconsistencies.
 */
public class TapirMetadataSynchronizer extends BaseProtocolHandler {
  private static final Logger LOG = LoggerFactory.getLogger(TapirMetadataSynchronizer.class);
  ...
  public TapirMetadataSynchronizer(HttpClient httpClient) {
    super(httpClient);
  }
